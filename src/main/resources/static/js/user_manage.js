$(function () {
	...
	$('tbody.result-list').html(tbodyInnerHtml);
            ...
            // $("#modify").on("click", function (e) {
            	// //获取用户id
			// 	//ajax请求userManage/allDatas路径
			// 	//window.location.href="change.html";
            //
             //    var user_id = $(e.target).parents('tr').data();
             //    console.log(user_id);
			// });
