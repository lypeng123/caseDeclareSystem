...
var modifySaveUrl = path +'/userManage/opeationDatas'; //管理员修改用户信息后保存

var checkCaseByUserIdUrl = path + '/userManage/findCaseByUserId'; //管理员根据用户id查看对应案例

var returnWordUrl = path + '/userManage/returnWord'; //退回用户申报文档
